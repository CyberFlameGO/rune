...
impl Protocol {
    ...
    /// Function to access a tuple index on the given type.
    ///
    /// Signature: `fn(self, usize) -> Option<Value>`.
    pub const TUPLE_INDEX_GET: Protocol = Protocol {
        name: "tuple_index_get",
        hash: Hash::new(0x4c948e3534b758f8),
    };
}
